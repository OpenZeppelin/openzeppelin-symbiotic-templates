...
mod tests {
        ...
        r#"{
            "source": {
                "layerzero": {
                    ...
                    "exampleApp": "0x2222222222222222222222222222222222222222"
                }
            },
            "destination": {
                "layerzero": {
                    "dvn": "0x3333333333333333333333333333333333333333",
                    "exampleApp": "0x4444444444444444444444444444444444444444"
                },
                "relayInfra": {
        ...
        let context = write_test_files(
            ...
            r#"{
                ...
                "destination": { "chainlinkCcv": {
                    ...
                    "router": "0x1616161616161616161616161616161616161616",
                    "rmn": "0x1717171717171717171717171717171717171717",
            ...
            r#"{
                "source": {
                    "chainlinkCcv": {
                        ...
                        "rmn": "0x1313131313131313131313131313131313131313",
                ...
                "destination": {
                    "chainlinkCcv": {
                        ...
                        "router": "0x3434343434343434343434343434343434343434",
                        "rmn": "0x3535353535353535353535353535353535353535",
                        "onRamp": "0x3636363636363636363636363636363636363636",
    ...
    fn validate_warns_when_layerzero_oapp_is_disabled() {
        ...
        let context = write_test_files(
            ...
            r#"{
                "source": {
                    "layerzero": { "dvn": "0x1111111111111111111111111111111111111111" }
                },
                "destination": {
                    "layerzero": { "dvn": "0x3333333333333333333333333333333333333333" },
                    "relayInfra": {
                        "settlement": "0x5555555555555555555555555555555555555555"
                    }
                }
