...
- **EpochTooStale revert (0xf5ab0d81)** -- Settlement epoch data is stale. Refresh genesis or tune epoch timing. See [Troubleshooting](troubleshooting.md#epochtoostale-revert-0xf5ab0d81).
- **Watch does not reach success** -- CCV requires destination `MessageExecuted(messageId)`, not just relayer submission. See [Troubleshooting](troubleshooting.md#watch-does-not-reach-success).
- **Submission fails at estimate-gas** -- Common causes: stale epoch, incorrect CCV addresses, settlement not initialized. See [Troubleshooting](troubleshooting.md#submission-fails-at-estimate-gas).
